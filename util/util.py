...
class ConversationAgent(object):
    ...
    def extract_content(self):
        ...
        if self.payload:
            ...
            contents, content_types, quick_reply_id, complement_info_list = AnythingElseResponses().generate()
...
class AnythingElseResponses(object):
    ...
    def random_answer(self):
        self.content = ["Whoa!", "Thanks, I guess."]
...
class TextResponses(object):
    ...
    def generic(self):
        ...
        if self.content is None:
            self.content = [repeat_text(self.text)]
            self.content_type = ["text"]
            self.quick_reply_id = "main_menu"
            self.complement_info = [None]
